...
// Test ob File existiert
/*
fs.access('client_secret.json', fs.constants.R_OK | fs.constants.W_OK, (err) => {
...
function listSlides(auth) {
  ...
  slides.presentations.get({
    ...
    console.log(presentation.slides[1].pageElements[0].shape.text.textElements[1]);
  });
}